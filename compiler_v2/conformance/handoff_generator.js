...
/**
 * compiler_v2/conformance/handoff_generator.js
 *
 * Generates DEV_HANDOFF.md providing instructions for coding agents
 * (Codex, Claude Code) to complete functional wiring without visual drift.
 */

const fs = require('fs');
const path = require('path');

function generateHandoffGuide(outputPath = 'output/conformance') {
  const content = [
  ...
  fs.writeFileSync(path.join(outputPath, 'DEV_HANDOFF.md'), content, 'utf8');
  return content;
}
